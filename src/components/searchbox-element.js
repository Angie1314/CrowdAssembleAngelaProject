    ...
    this.innerHTML = `      
      ...
      <div class="card text-right bg-white">
         <div class="card-header bg-white">
            <ul id="members" class="text-left bg-white">
               <h3 class="text-left bg-white categories">Search</h3>
            </ul>
         </div>
         <div class="card-body bg-white" id="photo">
            <ul id="titles" class="card-title bg-white"></ul>
         </div>
...
customElements.define('search-element', SearchboxElement);